...
namespace edm {
  ...
  public:
    ...
    std::auto_ptr<BranchEntryInfo> getProvenance(BranchDescription const& desc) {
  ...
  private:
    ...
    virtual std::auto_ptr<BranchEntryInfo> getProvenance_(BranchDescription const& desc) const = 0;
