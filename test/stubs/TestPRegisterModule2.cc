/**
   ...
   \version $Id: TestPRegisterModule2.cc,v 1.5 2006/06/24 01:46:35 wmtan Exp $
   \date 19 May 2005
*/

static const char CVSId[] = "$Id: TestPRegisterModule2.cc,v 1.5 2006/06/24 01:46:35 wmtan Exp $";
